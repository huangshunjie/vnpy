"""write_pe_log.py — append LogTab class to log.py"""
import pathlib, ast

P = pathlib.Path(
    r"c:\Users\11229\Documents\GitHub\vnpy\vnpy\platform_engineering\ui\log.py"
)
...
class LogTab(QWidget):
    ...
    def _init_ui(self):
        ...
        self._kw_box.setPlaceholderText("\\u5173\\u952e\\u8bcd\\u8fc7\\u6ee4")
        ...
        btn_clear = QPushButton("\\U0001f5d1 \\u6e05\\u7a7a")
...
ast.parse(full)
print("LogTab OK, total lines:", len(full.splitlines()), "size:", P.stat().st_size)
