"""write_pe_monitor.py — append ObservabilityTab to monitor.py"""
import pathlib, ast

P = pathlib.Path(
    r"c:\Users\11229\Documents\GitHub\vnpy\vnpy\platform_engineering\ui\monitor.py"
)
...
class ObservabilityTab(QWidget):
    ...
    def _init_ui(self):
        ...
        self._sub.addTab(self._alert_table, "\\U0001f514  \\u544a\\u8b66")

        # rules tab
        self._rule_table = RuleTable()
        self._sub.addTab(self._rule_table, "\\U0001f4cb  \\u89c4\\u5219")
...
ast.parse(full)
print("ObservabilityTab OK, lines:", len(full.splitlines()), "size:", P.stat().st_size)
