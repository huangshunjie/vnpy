...
class AlphaFactoryWidget(QtWidgets.QMainWindow):
    ...
    def _build_left_panel(self) -> QtWidgets.QWidget:
        ...
        title.setStyleSheet(
            f"color: {_MAV}; font-size: 15px; font-weight: bold; border: none;")
        v.addWidget(title)

        sub = QtWidgets.QLabel("工业化Alpha生产系统")
        sub.setStyleSheet(f"color: {_MUT}; font-size: 12px; border: none;")
        v.addWidget(sub)
        ...
        lbl_ev.setStyleSheet(f"color: {_MUT}; font-size: 12px; border: none;")
        v.addWidget(lbl_ev)
        self._lbl_last_event = QtWidgets.QLabel("---")
        self._lbl_last_event.setStyleSheet(
            f"color: {_MUT}; font-size: 13px; border: none;")
        ...
        for label, color, slot in [
            ...
            btn.setStyleSheet(
                ...
                f" padding: 6px 0px; font-size: 14px; }}"
    ...
    def _on_start(self) -> None:
        if self.af_engine:
            ...
            self._lbl_last_event.setStyleSheet(
                f"color: {_GRN}; font-size: 13px; border: none;")
    ...
    def _on_stop(self) -> None:
        if self.af_engine:
            ...
            self._lbl_last_event.setStyleSheet(
                f"color: {_RED}; font-size: 13px; border: none;")
    ...
    def _row(
        ...
        ln.setStyleSheet(f"color: {_MUT}; font-size: 12px;")
