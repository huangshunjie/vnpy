...
class _KpiCard(QtWidgets.QWidget):
    def __init__(self, title: str, parent=None) -> None:
        ...
        self._lt.setStyleSheet(f"color: {_MUT}; font-size: 12px; border: none;")
...
class ReportTab(QtWidgets.QWidget):
    ...
    def _build_distribution_panel(self) -> QtWidgets.QWidget:
        ...
        lbl.setStyleSheet(
            f"color: {_MUT}; font-size: 12px; font-weight: bold;")
        v.addWidget(lbl)
        ...
        for s in AlphaStatus:
            ...
            name_lbl.setStyleSheet(
                f"color: {color}; font-size: 13px; min-width: 90px;")
    ...
    def _build_live_table(self) -> QtWidgets.QWidget:
        ...
        self._tbl_live.setStyleSheet("font-size: 13px;")
