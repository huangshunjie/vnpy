...
class _ThresholdRow(QtWidgets.QWidget):
    def __init__(self, label: str, default: float,
        ...
        lbl.setStyleSheet(f"color: {_MUT}; font-size: 12px; min-width: 110px;")
...
class ScreeningTab(QtWidgets.QWidget):
    ...
    def _build_threshold_panel(self) -> QtWidgets.QWidget:
        ...
        lbl_ret.setStyleSheet(
            f"color: {_ORG}; font-size: 13px; font-weight: bold; border: none;")
        v.addWidget(lbl_ret)
        ...
        sl.setStyleSheet(f"color: {_MUT}; font-size: 12px; min-width: 110px;")
        sh.addWidget(sl)
        ...
        btn_apply.setStyleSheet(
            ...
            f" padding: 6px 0px; font-size: 14px; font-weight: bold; }}"
    ...
    def _build_retire_table(self) -> QtWidgets.QWidget:
        ...
        lbl.setStyleSheet(f"color: {_ORG}; font-size: 12px;")
        v.addWidget(lbl)
