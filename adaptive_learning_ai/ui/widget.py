"""
adaptive_learning_ai/ui/widget.py  (Phase 1 Stub)

AdaptiveLearningWidget — 自适应学习系统主窗口骨架。
布局：左侧状态面板 + 右侧 6-Tab（全部占位）。
...
class AdaptiveLearningWidget(QtWidgets.QMainWindow):
    """
    自适应学习系统主窗口（Phase 1）。

    左侧：学习状态面板（系统状态 / 学习周期 / 关键指标占位）
    右侧：6-Tab 布局
      0. Dashboard  — 总览
      1. Feedback   — 反馈采集
      2. Learning   — 学习引擎
    ...
    def _init_ui(self) -> None:
        self.setWindowTitle("Adaptive Learning AI  自适应学习系统")
    ...
    def _build_status_panel(self) -> QtWidgets.QWidget:
        ...
        btn_start = QtWidgets.QPushButton("▶  启动学习引擎")
    ...
    def _on_refresh(self) -> None:
        ...
        eng = summ.get("engine", {})
        self._status_labels["cycles"].setText(
            str(eng.get("cycle_count", 0)))
        self._status_labels["feedback"].setText("--")
        self._status_labels["adapted"].setText("--")
