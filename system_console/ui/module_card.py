...
def _q(color: str) -> str:
    ...
    return f"color:{color};font-size:11px;font-weight:bold;border:none;background:transparent;"
...
class ModuleCard(QtWidgets.QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        self._lbl_name.setStyleSheet(
            f"color:{_FG};font-weight:bold;font-size:13px;"
    ...
    def _make_btn(text: str, color: str, slot) -> QtWidgets.QPushButton:
        ...
        b.setStyleSheet(
            ...
            f"border:none;border-radius:3px;font-size:11px;padding:0 4px;}}"
    ...
    def refresh(self, entry_dict: dict) -> None:
        ...
        self._dot.setStyleSheet(
            f"color:{dot_c};font-size:13px;"
            f"border:none;background:transparent;")
        self._lbl_state.setText(state_str)
        self._lbl_state.setStyleSheet(
            f"color:{dot_c};font-size:11px;border:none;background:transparent;")
