...
if old_code in content:
    ...
    print("\n✓ 修复已应用到 vnpy/trader/stock_pool.py")
    print("\n修改内容：")
    print("  - 将异步后台加载改为同步加载")
