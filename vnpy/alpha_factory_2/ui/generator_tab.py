...
class GeneratorTab(QtWidgets.QWidget):
    ...
    def _build_control_panel(self) -> QtWidgets.QWidget:
        ...
        self._chk_neg.setStyleSheet(f"color: {_MUT}; font-size: 10px; border: none;")
        ...
        self._lbl_sel.setStyleSheet(f"color: {_MUT}; font-size: 9px; border: none;")
        ...
        btn.setStyleSheet(
            ...
            f" padding: 8px 0px; font-size: 13px; font-weight: bold; }}"
    ...
    def _build_alpha_table(self) -> QtWidgets.QWidget:
        ...
        self._lbl_count.setStyleSheet(
            f"color: {_MAV}; font-size: 11px; font-weight: bold;")
    ...
    def _lbl(self, text: str) -> QtWidgets.QLabel:
        ...
        l.setStyleSheet(f"color: {_MUT}; font-size: 10px; border: none;")
        return l
