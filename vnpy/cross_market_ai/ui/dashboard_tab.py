...
Phase 4: Dashboard â€” è·¨å¸‚åœºæ€»è§ˆé¢æ¿ã€‚
"""
...
class DashboardTab(QtWidgets.QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        btn = QtWidgets.QPushButton("âŸ³  åˆ·æ–°æ€»è§ˆ")
    ...
    def _build_status_cards(self) -> QtWidgets.QWidget:
        ...
        self._card_status   = _StatusCard("ç³»ç»ŸçŠ¶æ€",    "IDLE",    "#607d8b")
        self._card_phase    = _StatusCard("å½“å‰é˜¶æ®µ",    "Phase 4", "#1565c0")
        self._card_mapped   = _StatusCard("å·²æ˜ å°„å¸‚åœº",  "0",       "#2e7d32")
        self._card_transfer = _StatusCard("è¿ç§»æ¬¡æ•°",    "0",       "#6a1b9a")
        self._card_scored   = _StatusCard("å·²è¯„åˆ†Alpha", "0",       "#e65100")
        self._card_top      = _StatusCard("æœ€é«˜æ™®é€‚æ€§",  "-",       "#4caf50")
    ...
    def _build_feasibility_matrix(self) -> QtWidgets.QGroupBox:
        group = QtWidgets.QGroupBox("Alpha è¿ç§»å¯è¡Œæ€§çŸ©é˜µï¼ˆç»“æ„ç›¸ä¼¼åº¦ï¼‰")
        layout = QtWidgets.QVBoxLayout(group)
        ...
        note = QtWidgets.QLabel("ç»¿è‰² â‰¥ 0.7  æ©™è‰² â‰¥ 0.4  çº¢è‰² < 0.4")
    ...
    def _build_universality_panel(self) -> QtWidgets.QGroupBox:
        ...
        sl.setSpacing(6)
        lbl_t = QtWidgets.QLabel("ç­‰çº§åˆ†å¸ƒ")
