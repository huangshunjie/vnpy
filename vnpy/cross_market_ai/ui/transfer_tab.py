...
Phase 3: Alpha Transfer Monitor — Alpha 迁移监控面板。
"""
...
class TransferTab(QtWidgets.QWidget):
    ...
    def _build_control_panel(self) -> QtWidgets.QFrame:
        ...
        layout.addWidget(QtWidgets.QLabel("源市场 (训练):"))
        ...
        btn_single = QtWidgets.QPushButton("▶  执行迁移")
        ...
        layout.addWidget(QtWidgets.QLabel("批量迁移 — Alpha:"))
        ...
        layout.addWidget(QtWidgets.QLabel("批量迁移 — 源市场:"))
        ...
        btn_batch = QtWidgets.QPushButton("▶▶  批量迁移所有市场")
        ...
        layout.addWidget(_hline())
        self._stat_total = _stat_row("总迁移次数")
        self._stat_ok    = _stat_row("成功")
        self._stat_rej   = _stat_row("拒绝")
        self._stat_avg   = _stat_row("平均T系数")
    ...
    def _build_conditions_panel(self) -> QtWidgets.QGroupBox:
        group = QtWidgets.QGroupBox("迁移条件评分 & 迁移系数 T")
    ...
    def _update_conditions(self, rec: dict) -> None:
        ...
        text  = f"?  ��Ǩ��  ({conf})" if ok else f"?  �ܾ�Ǩ�ƣ�{reason}"
